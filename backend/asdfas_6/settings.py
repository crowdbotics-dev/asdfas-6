"""
Django settings for asdfas_6 project.
...
WSGI_APPLICATION = 'asdfas_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asdfas_6 API",
    "DESCRIPTION": "API documentation for asdfas_6 App",
    "VERSION": "v1",
}
